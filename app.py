...
SYSTEM_PROMPT   = os.environ.get(
      ...
      "Keep replies concise and use plain text only — no markdown, asterisks, or bullet symbols."
)
                    ...
                    for entry in data.get("entry", []):
                        ...
                        mark_as_read(message_id)
                                    send_whatsapp_message(
                                                                  from_number,
                                                                  f"I received your {msg_type}, but I can only handle text and images right now!"
                                    )
except Exception as e:
